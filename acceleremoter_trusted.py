...
accelerometerLanding_node1677076769599 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://rp-udacity-sparklakes/accelerometer/landing/"],
        "recurse": True,
    },
...
S3bucket_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://rp-udacity-sparklakes/customers/trusted/"],
        "recurse": True,
    },
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://rp-udacity-sparklakes/accelerometer/trustedtwo/",
        "partitionKeys": [],
    },
