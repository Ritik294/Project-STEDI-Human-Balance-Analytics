...
accelerometertrusted_node1677079259061 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://rp-udacity-sparklakes/accelerometer/trustedtwo/"],
        "recurse": True,
    },
...
S3bucket_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://rp-udacity-sparklakes/step_trainer/landing/"],
        "recurse": True,
    },
...
customercurated_node1677075055867 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://rp-udacity-sparklakes/customers/curated/"],
        "recurse": True,
    },
...
step_with_accelerometed_trusted_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://rp-udacity-sparklakes/step_trainer/trusted_with_accelerometer/",
        "partitionKeys": [],
    },
